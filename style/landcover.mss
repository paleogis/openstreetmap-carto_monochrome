...
@grass: #E1E5E5;        // Lch(90,32,128) also grassland, meadow, village_green, garden, allotments
@scrub: #E1E5E5;        // Lch(84,24,122)
@forest: #E1E5E5;       // Lch(80,30,135)
@forest-text: #0c0d0c;  // Lch(40,30,135)
@park: #E1E5E5;         // Lch(94,30,145)
@allotments: #E1E5E5;   // Lch(87,20,135)
@orchard: #E1E5E5; // also vineyard, plant_nursery
@hedge: @forest;       // Lch(80,30,135)

// --- "Base" landuses ---

@built-up-lowzoom: #E1E5E5;
@built-up-z12: #E1E5E5;
@residential: #ededed;      // Lch(89,0,0)
@residential-line: #E1E5E5; // Lch(75,0,0)
@retail: #E1E5E5;           // Lch(89,16,30)
@retail-line: #E1E5E5;      // Lch(70,25,30)
@commercial: #E1E5E5;       // Lch(89,8.5,25)
@commercial-line: #E1E5E5;  // Lch(75,12,25)
@industrial: #E1E5E5;       // Lch(89,9,330) (Also used for railway, wastewater_plant)
@industrial-line: #E1E5E5;  // Lch(75,11,330) (Also used for railway-line, wastewater_plant-line)
@farmland: #E1E5E5;         // Lch(94,14,112)
@farmland-line: #E1E5E5;    // Lch(80,14,112)
@farmyard: #E1E5E5;         // Lch(89,20,80)
@farmyard-line: #E1E5E5;    // Lch(75,25,80)

// --- Transport ----

@transportation-area: #EFF0F0;
@apron: #EFF0F0;
@garages: #EFF0F0;
@parking: #EFF0F0;
...
@rest_area: #EFF0F0; // also services

// --- Other ----

@bare_ground: #EFF0F0;
@campsite: #EFF0F0; // also caravan_site, picnic_site
@cemetery: #EFF0F0; // also grave_yard
@construction: #EFF0F0; // also brownfield
@heath: #EFF0F0;
@mud: rgba(203,177,154,0.3); // produces #e6dcd1 over @land
@place_of_worship: #EFF0F0; // also landuse_religious
@place_of_worship_outline: darken(@place_of_worship, 30%);
@leisure: lighten(@park, 5%);
@power: darken(@industrial, 5%);
@power-line: darken(@industrial-line, 5%);
@sand: #EFF0F0;
@societal_amenities: #EFF0F0;   // Lch(99,13,109)
@tourism: #EFF0F0;
@quarry: #EFF0F0;
@military: #EFF0F0;
@beach: #EFF0F0;
...
@pitch: #EFF0F0;           // Lch(83,35,166) also track
@track: @pitch;
